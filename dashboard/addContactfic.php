...
<main id="main" class="main">
        ...
        <section class="section">
          ...
          <div class="row">
            <div class="col-lg-12">
                <span class=" h2 d-flex justify-content-center text-decoration-underline align-items-center">Formulaire d'importation des contacts</span>
                <!-- Multi Columns Form -->
                    <?php
						if(isset($message))
						{	?>
					...
					?>
                <form class="row g-3" enctype="multipart/form-data" action="addContact.php" method="POST">
                    <div class="col-md-12">
                        <label for="inputName5" class="form-label">Fichier(csv)</label>
                        <input type="file" required class="form-control" id="nom" name="nom" >
                    </div>
