...
<head>
  ...
  <title>Dashboard - SMSFLASH</title>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a href="#">Mon code de parainnage : </a> <h6 class="text-center text-success" style="border: 2px solid;" ><?php echo Session::get("user")[0]["code_parrainage"] ?></h6>
                        </li>
                        <hr class="dropdown-divider">
                        <li>
