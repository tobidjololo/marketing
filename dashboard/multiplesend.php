<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if($nbr['credits_restants'] > 0) {
            ...
            $n = Session::get("user")[0]['credits_restants'] - 1;
...
<main id="main" class="main">
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Envoyer message multiple</li>
            </ol>
          </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
          ...
          <div class="row m-5">
            <div class="col-lg-12">
                <span class=" h2 d-flex justify-content-center text-decoration-underline align-items-center">Envoi rapide plusieurs messages</span>
                <!-- Multi Columns Form -->
                    <?php
					...
					?>
                <form class="row g-3"  id="creer_eva" method="POST">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="recepteur" class="form-label">Telephone du recepteur</label>
                        <select style="border: solid 2px;border-color: red;" name="recepteur" id="recepteur" required class="form-control selectpicker" multiple data-live-search="true">

                            <option>Choisissez l'employé concerné</option>
                            <?php
                                $a = new Messages();
                                $nbr = $a->nbrAll('MesContacts',Session::get('user')[0]["id"],'id_client');
                                var_dump($nbr);
                                foreach($nbr as $element) {
                            ?>
                            <option value="<?php echo  $element['telephone'] ?>"><?php echo  $element['telephone'] ?></option>
                            <?php
                                }
                            ?>
                        </select>                    
