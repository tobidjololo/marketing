              ...
              <div class="row">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                          <h6 style="color: rgb(255, 255, 255)">
                            <?php   
                                $user = new User();
                                $nbr = $user->nbrMessages('Messages',1,1);
                                echo($nbr[0]['nbr']); 
                            ?>
                            </h6>
                ...
                <div class="col-xxl-4 col-md-4">
                  <div class="card info-card sales-card" style="background-color: blue">
                    ...
                    <div class="card-body">
                      <h5 class="card-title" style="color: rgb(255, 255, 255)">Clients inscrits</h5>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                          <h6 style="color: rgb(255, 255, 255)">
                            <?php
                              $nbr = $user->nbrMessages('User',"user","type");
                              echo($nbr[0]['nbr']); 
                            ?>
                          </h6>
                ...
                <div class="col-xxl-4 col-md-4">
                  <div class="card info-card sales-card" style="background-color: orange">
                    ...
                    <div class="card-body">
                      <h5 class="card-title" style="color: rgb(255, 255, 255)">Nombre de souscrit à un pack</h5>
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="ps-3">
                            <h6 style="color: rgb(255, 255, 255)">
                            <?php   
                                $nbr1 = $user->nbrMessages('Souscription', 1,1);
                                echo($nbr1[0]['nbr']); 
                            ?>
                            </h6>
                            <span style="color: rgb(255, 255, 255)" class="pt-1 fw-bold">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table datatable">
                                ...
                                <tbody>
                                    <?php
                                        $user = new User();
                                        $donnes = $user->selectAllByElement(1,1,"Messages");
                                        $a = 1;
